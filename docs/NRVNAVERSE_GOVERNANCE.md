...
| `feat/*` | NRVNAVerse feature branches | Branch from `nrvna/integration`; after independent review, integrate through a deterministic checkpoint. Prefer clean fast-forward integration where branch topology permits it; use a PR when useful or necessary |
